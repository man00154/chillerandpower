...
​
Manish Singh​
File "/mount/src/chillerandpower/app.py", line 250, in <module> <b>Supply:</b> {sim["supply_temp"]:.1f} °C<br> ~~~^^^^^^^^^^^^^^^
...
if menu == "Chillers":
    ...
    for row in range(num_rows):
        ...
        for col_idx in range(CHILLERS_PER_ROW):
            ...
            # derive safe numeric values from sim
            ...
            col.markdown(
                ...
                <div style='background:#111;padding:6px;font-size:11px;color:#ddd;'>
                    <b>Setpoint:</b> {sp:.1f} °C<br>
                    <b>Supply:</b> {supply:.1f} °C<br>
                    <b>Inlet:</b> {inlet:.1f} °C<br>
                    <b>Outlet:</b> {outlet:.1f} °C<br>
                    <b>Ambient:</b> {ambient:.1f} °C<br>
                    <b>Comp-1:</b> {comp1:.0f} %<br>
                    <b>Comp-2:</b> {comp2:.0f} %<br>
                    <b>Power:</b> {power_kw:.1f} kW<br>
                    <b>Flow:</b> {flow:.1f} m³/hr<br>
                </div>
                """,
                unsafe_allow_html=True,
            )
